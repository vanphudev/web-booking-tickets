...
import {Card, Typography, Row, Col, Divider, Button, QRCode, message, Spin} from "antd";
...
const TicketComponent = ({bookingInfo, ticket}) => {
   ...
   return (
      <div className='ticket-wrapper p-3'>
         <Spin size='large' spinning={isLoading} tip='Đang xử lý lấy vé...'>
            <Card
               ref={ticketRef}
               ...
               <Row justify='space-between' style={{marginBottom: 8}}>
                  ...
                  <Typography.Text strong style={{fontSize: 16, color: "#00613D"}}>
                     {formatTime(bookingInfo?.trip_info?.departure_time)}{" "}
                     {formatDate(bookingInfo?.trip_info?.trip_date)}
                  </Typography.Text>
               </Row>
               <Row justify='space-between' style={{marginBottom: 8}}>
               ...
               <Row justify='space-between' style={{marginBottom: 8, width: "100%"}}>
                  ...
                  <p style={{fontSize: 16, color: "#E8460D", textAlign: "right", fontWeight: 600}}>
                     {bookingInfo?.location_info?.pickup?.point
                        ? `${bookingInfo?.location_info?.pickup?.point} - (Văn phòng/Bến xe)`
               ...
               <Row justify='space-between' style={{marginBottom: 16}}>
                  ...
                  <p style={{fontSize: 18, color: "#00613D", fontWeight: 800}}>
                     {formatCurrency(ticket?.ticket_amount)}
                  </p>
               </Row>
