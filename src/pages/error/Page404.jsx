            ...
            <div className='flex flex-col items-center justify-center px-2'>
               ...
               <div>
                  <Typography.Paragraph type='secondary' className='text-center'>
                     Trang web bạn đang tìm kiếm có thể đã bị xóa hoặc giới hạn truy cập. Vui lòng quay lại trang chủ.
               ...
               <NavLink
                  to={REACT_APP_HOMEPAGE}
                  style={{background: "#DB3107", color: "#fff"}}
