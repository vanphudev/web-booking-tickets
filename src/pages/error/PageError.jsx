...
const REACT_APP_HOMEPAGE = import.meta.env.VITE_APP_HOME_PAGE;
...
export default function PageError() {
   ...
   const colorBgBase = "#fff";
   const colorTextBase = "#000";
   const colorPrimary = "#000";
   const colorPrimaryActive = "#000";
   ...
   return (
      <div>
         ...
         <div className='m-auto flex h-[100vh] max-w-[500px] items-center justify-center py-2'>
            <div className='flex flex-col items-center justify-center px-2'>
               <div>
                  <Typography.Title level={3} className='text-center'>
                     Server của chúng tôi đang bảo trì - Sự cố đã xảy ra trong quá trình xử lý.
                  </Typography.Title>
               </div>
               <div>
                  <Typography.Title level={3} className='text-center'>
                     Server đang bảo trì. Vui lòng quay lại sau. Rất mong bạn sớm quay lại.
                  </Typography.Title>
               </div>
               <div>
                  <svg
               ...
               <button style={{background: "#DB3107", color: "#fff"}} className='rounded-md p-4' onClick={goHome}>
                  Quay về trang chủ
               </button>
            </div>
         </div>
